...
FUNCTION_DEFAULT_ARGS: dict[str, dict[str, Any]] = {
    ...
    "Price Share Distribution": {"price_range_size": 1},
    "Area Share Distribution": {"area_range_size": 20},
    "Monthly Supply Volume": {"col_names": ["supply_counts", "trade_counts"]},
    "Monthly Supply Trend": {"col_names": ["supply_counts", "trade_counts"]},
    "Annual Avg Price": {"col_names": ["avg_price", "yoy_pct"]},
    "Annual Avg Price & YoY Growth": {"col_names": ["avg_price", "yoy_pct"]},
    "Annual Supply Ratio": {"col_names": ["supply_ratio"]},
    "Annual Supply Ratio Trend": {"col_names": ["supply_ratio"]},
    "Area Year Pivot": {
        "area_range_size": 20,
        "col_names": ["supply_counts", "trade_counts"],
    },
    "Annual Supply Trade": {"col_names": ["supply_counts", "trade_counts"]},
    "Annual Supply-Demand Comparison": {},
    "Supply-Transaction Area": {},
    "Historical Delivery Metrics": {},
    "Annual Delivery Unit Count": {},
...
def get_default_function_args(function_key: str) -> dict[str, Any]:
    ...
    return deepcopy(FUNCTION_DEFAULT_ARGS.get(function_key, {}))
